...
| Bend arrows       | drag an arrow's midpoint dot anywhere — two more dots appear beside it, subdividing forever; double-click a dot to remove it |
| Arrow labels      | double-click an arrow to type a label on the line            |
